...
//        {
//            if (CustomerSales.Condition == null || CustomerSales.OwnershipTerm == null)
//            {
...
//            CustomerSales.SerialNumber = CustomerSales.SerialNumber;
//            CustomerSales.Condition = CustomerSales.Condition;
//            CustomerSales.UsedDamage = CustomerSales.UsedDamage;
//            CustomerSales.OwnershipTerm = CustomerSales.OwnershipTerm;
//            CustomerSales.Loading = CustomerSales.Loading;
//            CustomerSales.Fence = CustomerSales.Fence;
//            CustomerSales.Access = CustomerSales.Access;
...
//            if (Brand != "")
//            {
//                CList = CList.Where(x => x.Inventory.Brand.ToLower().Contains(Brand.ToLower())).ToList();
//            }

//            if (Serial != "")
//            {
//                CList = CList.Where(x => x.SerialNumber.ToLower().Contains(Serial.ToLower())).ToList();
//            }
...
//                        x.Customer.Email.ToLower().Contains(searchValue.ToLower()) ||
...
//                {
//                    inventory = u.Inventory.Brand;
//                    serialNumber = u.Inventory.extra1;
//                }
//                else
//                {
//                    inventory = "";
...
//                    CustomerSalesCondition = u.Condition,
//                    CustomerUsedDamage = u.UsedDamage,
//                    CustomerSalesOwnership = u.OwnershipTerm,
...
//            c.SerialNumber = CustomerSales.SerialNumber;
//            c.Condition = CustomerSales.Condition;
//            c.UsedDamage = CustomerSales.UsedDamage;
//            c.OwnershipTerm = CustomerSales.OwnershipTerm;
//            c.Loading = CustomerSales.Loading;
//            c.Fence = CustomerSales.Fence;
//            c.Access = CustomerSales.Access;
